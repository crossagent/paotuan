...
class TurnController:
    ...
    @classmethod
    def create_dm_turn(cls) -> "TurnController":
        """创建新的DM回合
        
        Returns:
            TurnController - 新创建的回合控制器
        """
    ...
    @classmethod
    def create_action_turn(cls, active_players: List[str]) -> "TurnController":
        """创建新的玩家行动回合
    ...
    @classmethod
    def create_dice_turn(cls, active_players: List[str], difficulty: int, action_desc: str = "行动") -> "TurnController":
        """创建新的掷骰子回合
